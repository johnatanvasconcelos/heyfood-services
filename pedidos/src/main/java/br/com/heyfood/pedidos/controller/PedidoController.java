...
public class PedidoController {
        ...
        public ResponseEntity<PedidoDto> atualizaStatus(@PathVariable Long id, @RequestBody @Valid AtualizaStatusDto status){
